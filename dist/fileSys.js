...
function appendFile(path, data, options) {
	return (0, promises_1.appendFile)(path, data, options).catch(error => {
		if (error.code === 'ENOENT') return (0, promises_1.mkdir)((0, path_1.dirname)(path.toString()), { recursive: true }).then(() => (0, promises_1.appendFile)(path, data, options));
		return error;
	});
}
