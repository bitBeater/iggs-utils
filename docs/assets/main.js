(() => {
	...
	var De = (t, e, r) => {
			if ((e && typeof e == 'object') || typeof e == 'function') for (let n of Oe(e)) !_e.call(t, n) && n !== 'default' && J(t, n, { get: () => e[n], enumerable: !(r = Pe(e, n)) || r.enumerable });
			return t;
		},
		Ae = t => De(Me(J(t != null ? Ce(Re(t)) : {}, 'default', t && t.__esModule && 'default' in t ? { get: () => t.default, enumerable: !0 } : { value: t, enumerable: !0 })), t);
	var de = Fe((ue, he) => {
		(function () {
			var t = function (e) {
				var r = new t.Builder();
...
`,
				...
				var e = {
					...
					z = function (u) {
						...
						if (((S = u.substr(0, 1)), S == 'y' && (u = S.toUpperCase() + u.substr(1)), (d = E), (x = p), d.test(u) ? (u = u.replace(d, '$1$2')) : x.test(u) && (u = u.replace(x, '$1$2')), (d = m), (x = T), d.test(u))) {
							...
							var L = x.exec(u);
							(g = L[1]), (x = y), x.test(g) && ((u = g), (x = k), (R = M), (D = j), x.test(u) ? (u = u + 'e') : R.test(u) ? ((d = w), (u = u.replace(d, ''))) : D.test(u) && (u = u + 'e'));
						}
						if (((d = V), d.test(u))) {
							var L = d.exec(u);
							(g = L[1]), (u = g + 'i');
						...
						if (s.editsRemaining != 0) {
							...
							if (s.str.length > 1) {
								var h = s.str.charAt(0),
									f = s.str.charAt(1),
									v;
								f in s.node.edges ? (v = s.node.edges[f]) : ((v = new t.TokenSet()), (s.node.edges[f] = v)), s.str.length == 1 && (v.final = !0), i.push({ node: v, editsRemaining: s.editsRemaining - 1, str: h + s.str.slice(2) });
							}
						}
					}
					return n;
							...
							for (var h = s[l], f = 0; f < c; f++) {
								...
								if (v == h || h == '*') {
									var b = n.node.edges[v],
										...
										E = b.final && y.final,
										p = void 0;
									v in n.output.edges ? ((p = n.output.edges[v]), (p.final = p.final || E)) : ((p = new t.TokenSet()), (p.final = E), (n.output.edges[v] = p)), i.push({ qNode: y, output: p, node: b });
								}
							}
					}
					return r;
			...
			(t.Index = function (e) {
				...
				(t.Index.prototype.query = function (e) {
					for (var r = new t.Query(this.fields), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), c = 0; c < this.fields.length; c++) i[this.fields[c]] = new t.Vector();
					e.call(r, r);
				...
				(t.Index.load = function (e) {
					...
					return a.finish(), (r.fields = e.fields), (r.fieldVectors = n), (r.invertedIndex = s), (r.tokenSet = a.root), (r.pipeline = c), new t.Index(r);
				});
			(t.Builder = function () {
				(this._ref = 'id'),
	...
	var ee = class extends Z {
			...
			hideShowToolbar() {
				...
				(this.showToolbar = this.lastY >= this.scrollTop || this.scrollTop <= 0),
					e !== this.showToolbar && (this.toolbar.classList.toggle('tsd-page-toolbar--hide'), (r = this.secondaryNav) == null || r.classList.toggle('tsd-navigation--toolbar-hide')),
