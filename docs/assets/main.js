(() => {
	...
	var De = (t, e, r, n) => {
			if ((e && typeof e == 'object') || typeof e == 'function') for (let i of Oe(e)) !_e.call(t, i) && (r || i !== 'default') && J(t, i, { get: () => e[i], enumerable: !(n = Pe(e, i)) || n.enumerable });
			return t;
		},
		Ae = (t, e) => De(Me(J(t != null ? Ce(Re(t)) : {}, 'default', !e && t && t.__esModule ? { get: () => t.default, enumerable: !0 } : { value: t, enumerable: !0 })), t);
	var de = Fe((ce, he) => {
		(function () {
			var t = function (e) {
				var r = new t.Builder();
